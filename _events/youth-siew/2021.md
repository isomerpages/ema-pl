...
<div style="margin:auto; border: 4px solid; border-radius: 25px; padding: 20px 20px; border-color:#4EC4DD ">
    <div style="text-align:center;">
        <strong>
            For the first time, we open the showcase to the public to share comments and ideas on the Youth Energy Showcase. <br> The form will be open till 26 November 2021.
        </strong>
        <br>
    </div>
    <div style="text-align:center;" >
